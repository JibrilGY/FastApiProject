...
router = APIRouter(prefix="/cancer-knn", tags=["Cancer KNN Model"])

BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
MODEL_PATH = os.path.join(BASE_DIR, "models", "cancer", "knn_model.pkl")
...
@router.post("/predict-knn", response_model=StandardResponse)
