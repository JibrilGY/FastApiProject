...
def predict_survival(data: PassengerInput):
    ...
    # İsimden unvan çıkarma kodunu sildik çünkü Title doğrudan verinin içinden (arayüzden) geliyor!
    ...
    # 5. TAHMİN YAPMA
    # (Eskiden burada olan manuel 'scaler' kodunu sildik çünkü pipeline_model bunu kendisi yapıyor)
