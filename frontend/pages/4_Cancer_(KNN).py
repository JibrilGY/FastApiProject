...
st.title("🎗️ Breast Cancer Prediction System (KNN)")
st.markdown(
    "Analyze tumor measurement values to determine benign or malignant status using the KNN algorithm."
)
st.divider()
...
if st.button(
  ...
  try:
    response = requests.post(
        "http://127.0.0.1:8000/cancer-knn/predict-knn", json=payload
    )
