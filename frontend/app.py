...
# DİKKAT: st.form yapısını kaldırdık!
# Çünkü "Cinsiyet" seçildiğinde sayfanın anında tepki verip
# "Unvan" seçeneklerini güncellemesini istiyoruz.
...
with col1:
    ...
    # YENİ: Cinsiyete Göre Dinamik Unvan Menüsü
    if sex == "male":
...
with col2:
    ...
    # İsmi sadece kozmetik olarak tutuyoruz
    name = st.text_input(
...
# Butonu form dışına standart olarak ekliyoruz
st.markdown("<br>", unsafe_allow_html=True)  # Araya ufak bir boşluk
...
if submit_button:
    payload = {
        "Pclass": pclass,
        "Sex": sex,
        "Title": title,  # YENİ EKLENDİ: Artık API bu veriyi bizden hazır bekliyor
        "Age": age,
        "Fare": fare,
        "SibSp": sibsp,
        "Parch": parch,
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            st.error("API'den beklenmeyen bir hata döndü. Lütfen terminali kontrol edin.")
